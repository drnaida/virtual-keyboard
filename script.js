...
let operatingSystem = document.createElement('p');
let keyToSwitchLanguage = document.createElement('p');
let descriptionOfShift = document.createElement('p');
...
function buildKeyboard() {
  ...
  let allKeyboardRows = document.querySelectorAll('.keyboard-row');
  ...
  let shift = document.querySelectorAll('.keyboard-button--shi');
  shift.forEach(item => {
    item.addEventListener('click', uppercaseValuesFlexible);
  });
  /*Add Event Listeners to virtual buttons*/
  let button = document.querySelectorAll('.keyboard-button');
  button.forEach(item => {
    item.addEventListener('mouseover', function() {buttonHover(item);});
    item.addEventListener('mouseout', function() {buttonHoverRemove(item);});
    item.addEventListener('mousedown', function() {buttonPressed(item);});
  ...
  let caps = document.querySelector('.keyboard-button--cap');
  caps.addEventListener('click', uppercaseValuesStable);
  /*Add Event Listeners to Backspace, Delete, Space, Tab, Enter*/
  document.querySelector('.keyboard-button--bac').addEventListener('click', function () {selectionFunction('', -1, 0)});
  document.querySelector('.keyboard-button--del').addEventListener('click', function() {selectionFunction('', 0, 1)});
  document.querySelector('.keyboard-button--spa').addEventListener('click', function() {selectionFunction(' ', 0, 0)});
  document.querySelector('.keyboard-button--tab').addEventListener('click', function() {selectionFunction('    ', 0, 0)});
  document.querySelector('.keyboard-button--ent').addEventListener('click', function() {selectionFunction('\n', 0, 0)});
...
function addItemsToTheRow(from, to, language, shift) {
  for (let j = from; j < to; j++) {
    ...
    let inner = keyboardButton.innerHTML;
...
/*Implement shift*/
function uppercaseValuesFlexible() {
  if (shiftPressed) {
    shiftPressed = false;
    buildKeyboard();
  } else {
...
function uppercaseValuesStable() {
  let keyboardButton = document.querySelectorAll('.keyboard-button--letter');
